...
class BitcoinLibTestCase extends MyCakeTestCase {
	...
	function testObject() {
		...
		$this->assertTrue(is_a($this->Bitcoin, 'BitcoinLib'));
	}
  ...
  public function testRemove0x() {
  	$this->assertEqual(Bitcoin::remove0x("abcdefg"), "abcdefg");
  	$this->assertEqual(Bitcoin::remove0x("0xabcdefg"), "abcdefg");
  	$this->assertEqual(Bitcoin::remove0x("0Xabcdefg"), "abcdefg");
  }
  ...
  public function testGetBlockCount() {
  	...
  	$this->assertEqual($res, $resOffline);
  }
